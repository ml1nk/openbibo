...
<table id="borrow">
  <tr>
    <td class="title" colspan="2">'.htmlentities($lang->aael[0], ENT_QUOTES).'</td>
  </tr>
    <tr>
...
<input name="user" type="hidden" value="'.$value2.'" >
  ...
  <tr>
<td colspan="2"><input type="submit" class="submit" value="'.htmlentities($lang->aaem[0], ENT_QUOTES).' "></td>
 </tr>
</form>
</table>
';
...
<table id="borrow">
  <tr>
    <td class="title" colspan="2">'.htmlentities($lang->aaek[0], ENT_QUOTES).'</td>
  </tr>
    <tr>
    <td class="left">'.htmlentities($lang->aaca[0], ENT_QUOTES).'</td>
<form action="#" method="post">
