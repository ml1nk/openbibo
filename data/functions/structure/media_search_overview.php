...
if ($info["available"])
{
$available='<td class="available" colspan="2">'.htmlentities($lang->aabf[0], ENT_QUOTES).'</td>';
}
else
{
$available='<td class="unavailable" colspan="2">'.htmlentities($lang->aabg[0], ENT_QUOTES).'</td>';
}
if ($link)
{
