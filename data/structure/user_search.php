...
{
$search_out = '<div id="error">'.htmlentities($lang->aabc[0], ENT_QUOTES)."<br/>".htmlentities($lang->aadp[0], ENT_QUOTES).'</div>';
}
}
...
{
$selected = '
<option value="1">'.htmlentities($lang->aacz[0], ENT_QUOTES).'</option>
<option value="2" selected>'.htmlentities($lang->aada[0], ENT_QUOTES).'</option>
...
$selected = '
<option value="1" >'.htmlentities($lang->aacz[0], ENT_QUOTES).'</option>
<option value="2">'.htmlentities($lang->aada[0], ENT_QUOTES).'</option>
...
{
$selected = '
<option value="1" selected>'.htmlentities($lang->aacz[0], ENT_QUOTES).'</option>
<option value="2">'.htmlentities($lang->aada[0], ENT_QUOTES).'</option>
<option value="3">'.htmlentities($lang->aaas[0], ENT_QUOTES).'</option>
';
}
