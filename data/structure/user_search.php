...
{
$media = getuserwithbarcode($_POST["search_text"]);
if($media!=null)
{
$search_out = user_search_overview($media,$lang);
}
else
{
...
{
$search_out = '<div id="error">'.htmlentities($lang->aabc[0], ENT_QUOTES, "UTF-8")."<br/>".htmlentities($lang->aadp[0], ENT_QUOTES, "UTF-8").'</div>';
}
}
...
{
$selected = '
<option value="1">'.htmlentities($lang->aacz[0], ENT_QUOTES, "UTF-8").'</option>
<option value="2" selected>'.htmlentities($lang->aada[0], ENT_QUOTES, "UTF-8").'</option>
...
$selected = '
<option value="1" >'.htmlentities($lang->aacz[0], ENT_QUOTES, "UTF-8").'</option>
<option value="2">'.htmlentities($lang->aada[0], ENT_QUOTES, "UTF-8").'</option>
...
{
$selected = '
<option value="1" selected>'.htmlentities($lang->aacz[0], ENT_QUOTES, "UTF-8").'</option>
<option value="2">'.htmlentities($lang->aada[0], ENT_QUOTES, "UTF-8").'</option>
<option value="3">'.htmlentities($lang->aaas[0], ENT_QUOTES, "UTF-8").'</option>
';
}
