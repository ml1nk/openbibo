...
{
 $body='
<div id="margin"><div id="error">'.htmlentities($lang->aafz[0], ENT_QUOTES).'<br/>'.htmlentities($lang->aaga[0], ENT_QUOTES).'</div></div>
';
}}
else
{
$body='
<div id="margin"><div id="error">'.htmlentities($lang->aafx[0], ENT_QUOTES).'<br/>'.htmlentities($lang->aafy[0], ENT_QUOTES).'</div></div>
';
}
}
else
